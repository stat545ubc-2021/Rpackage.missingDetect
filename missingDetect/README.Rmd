...
The goal of missingDetect is to calculate the proportion of missing values for each column in a dataset,and output the result of columns having NA existed.
